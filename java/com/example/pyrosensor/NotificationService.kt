...
class NotificationService : FirebaseMessagingService() {
    ...
    private fun createAlarmNotification(message: String, sensorName: String, customSound: String? = null) {
        ...
        val intent = Intent(this, WelcomeActivity::class.java).apply {
            ...
            // Add action to stop alarm sound when notification is tapped
            action = "STOP_ALARM"
        }
        ...
        // Create another intent specifically to stop the alarm service
        val stopIntent = Intent(this, AlarmService::class.java)
        val stopPendingIntent = PendingIntent.getService(
            this, 1, stopIntent, PendingIntent.FLAG_ONE_SHOT or PendingIntent.FLAG_IMMUTABLE
        )
