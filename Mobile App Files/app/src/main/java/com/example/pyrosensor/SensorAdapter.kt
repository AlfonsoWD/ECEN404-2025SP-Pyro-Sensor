...
class SensorAdapter(
    ...
    // Logging tag and state tracking
    ...
    inner class SensorViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        // Bind sensor data to view holder
    ...
    // Parse Firebase timestamp string to seconds
    ...
    // Bind sensor data to view holder at position
    override fun onBindViewHolder(holder: SensorViewHolder, position: Int) {
        val sensor = getItem(position)
        holder.bind(sensor)
    }

    // Update sensor list and handle state changes
    ...
    // Update sensor name in the list
